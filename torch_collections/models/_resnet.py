...
def resnet_fpn_feature_shape_fn(img_shape):
    ...
    C2_shape = torch.ceil(C1_shape / 2)

    P3_shape = torch.ceil(C2_shape / 2)
    P4_shape = torch.ceil(P3_shape / 2)
    P5_shape = torch.ceil(P4_shape / 2)

    P6_shape = torch.ceil(P5_shape / 2)
    P7_shape = torch.ceil(P6_shape / 2)
